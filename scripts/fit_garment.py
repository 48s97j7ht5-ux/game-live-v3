...
def fit(body: Image.Image, garment: Image.Image, source_body: Image.Image | None, margin: int, mask_out: bool) -> tuple[Image.Image, int]:
    dx = dy = 0
...
def main() -> int:
    ...
    out, dropped = fit(body, garment, source, args.margin, not args.no_mask)
