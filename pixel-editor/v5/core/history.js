  ...
  app.history={
    push(){
      ...
      app.state.undo.push({
        ...
        layers:app.state.layers.map(l=>({id:l.id,parentId:l.parentId,name:l.name,visible:l.visible,locked:l.locked,opacity:l.opacity,data:l.canvas.getContext('2d').getImageData(0,0,W,H)}))
      });
